...
INSERT INTO `aplicacion` VALUES (1,'Utilitarios','1',' icon-cogs',0,'2014-03-01 18:28:31','1'),(2,'Estadisticas','1','icon-bar-chart ',1,'2014-03-01 21:20:22','1'),(3,'Agua','1','icon-cloud',2,'2014-03-06 00:53:09','1'),(4,'Caja','1','icon-credit-card',3,'2014-03-06 00:55:30','1'),(5,'Administrador','1','icon-group ',4,'2014-03-13 22:09:07','1');
...
CREATE TABLE `caja_dinero` (
  ...
  `dCadFechaCierre` datetime NOT NULL,
  `dCadFechaRegistro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `cCadEstado` char(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`nCadId`),
  KEY `fk_caja_dinero_Trabajador_Municipal1_idx` (`nTmuId`),
  CONSTRAINT `fk_caja_dinero_Trabajador_Municipal1` FOREIGN KEY (`nTmuId`) REFERENCES `trabajador_municipal` (`nTmuId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contribuyente` (
  ...
  PRIMARY KEY (`nConId`),
  KEY `FK_Contribuyente_Calle` (`nCalId`),
  KEY `fk_contribuyente_persona1_idx` (`nPerId`),
  CONSTRAINT `FK_Contribuyente_Calle` FOREIGN KEY (`nCalId`) REFERENCES `calle` (`nCalId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Table structure for table `fraccionamiento_tributo`
--

DROP TABLE IF EXISTS `fraccionamiento_tributo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fraccionamiento_tributo` (
  `nFrtId` int(11) NOT NULL AUTO_INCREMENT,
  `dFrtFechaInicio` datetime DEFAULT NULL,
  `dFrtFechaFin` datetime DEFAULT NULL,
  `nConId` int(11) NOT NULL,
  `fFrtTotalTributo` double DEFAULT NULL,
  `fFrtTotalPorc` double DEFAULT NULL,
  `fFrtTotalDeduccion` double DEFAULT NULL,
  `fFrtTotalFraccion` double DEFAULT NULL,
  `fFrtTotalAbono` double DEFAULT NULL,
  `fFrtTotalSaldo` double DEFAULT NULL,
  `cFrtEstado` char(1) DEFAULT NULL,
  `cFrtAnioInicio` char(4) DEFAULT NULL,
  `cFrtMesInicio` char(2) DEFAULT NULL,
  `cFrtAnioFin` char(4) DEFAULT NULL,
  `cFrtMesFin` char(2) DEFAULT NULL,
  `cFrtObservacion` varchar(80) DEFAULT NULL,
  `cFrtCuotaTotal` int(11) DEFAULT NULL,
  `cFrtCuotaActual` int(11) DEFAULT NULL,
  `cFrtCuotaValor` double DEFAULT NULL,
  `cFrtFechaRegistro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Reg_Estado` char(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`nFrtId`),
  KEY `FK_Fraccionamiento_Tributo_Contribuyente` (`nConId`),
  CONSTRAINT `FK_Fraccionamiento_Tributo_Contribuyente` FOREIGN KEY (`nConId`) REFERENCES `contribuyente` (`nConId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fraccionamiento_tributo`
--

LOCK TABLES `fraccionamiento_tributo` WRITE;
/*!40000 ALTER TABLE `fraccionamiento_tributo` DISABLE KEYS */;
/*!40000 ALTER TABLE `fraccionamiento_tributo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fraccionamiento_tributo_cuota`
--

DROP TABLE IF EXISTS `fraccionamiento_tributo_cuota`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fraccionamiento_tributo_cuota` (
  `nFtcId` int(11) NOT NULL AUTO_INCREMENT,
  `nFrtId` int(11) NOT NULL,
  `dFtcFechaVcto` datetime DEFAULT NULL,
  `fFtcDeudaTributo` double DEFAULT NULL,
  `fFtcDeudaInteres` double DEFAULT NULL,
  `fFtcAbonoTributo` double DEFAULT NULL,
  `fFtcAbonoInteres` double DEFAULT NULL,
  `nFtcNotificacionNro` int(11) DEFAULT NULL,
  PRIMARY KEY (`nFtcId`),
  KEY `FK_Fraccionamiento_Tributo_Cuota_Fraccionamiento_Tributo` (`nFrtId`),
  CONSTRAINT `FK_Fraccionamiento_Tributo_Cuota_Fraccionamiento_Tributo` FOREIGN KEY (`nFrtId`) REFERENCES `fraccionamiento_tributo` (`nFrtId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fraccionamiento_tributo_cuota`
--

LOCK TABLES `fraccionamiento_tributo_cuota` WRITE;
/*!40000 ALTER TABLE `fraccionamiento_tributo_cuota` DISABLE KEYS */;
/*!40000 ALTER TABLE `fraccionamiento_tributo_cuota` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `imprime_deuda_tributo`
--

DROP TABLE IF EXISTS `imprime_deuda_tributo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `imprime_deuda_tributo` (
  `nConId` int(11) NOT NULL AUTO_INCREMENT,
  `Anio` char(4) NOT NULL,
  `Mes` char(2) NOT NULL,
  `T_Agua` double DEFAULT NULL,
  `T_Desague` double DEFAULT NULL,
  `T_Limpieza` double DEFAULT NULL,
  `T_Gastos` double DEFAULT NULL,
  `Porc_Reduccion` double DEFAULT NULL,
  `T_Deuda` double DEFAULT NULL,
  `T_Abono` double DEFAULT NULL,
  KEY `fk_imprime_deuda_tributo_contribuyente1_idx` (`nConId`),
  CONSTRAINT `fk_imprime_deuda_tributo_contribuyente1` FOREIGN KEY (`nConId`) REFERENCES `contribuyente` (`nConId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `imprime_deuda_tributo`
--

LOCK TABLES `imprime_deuda_tributo` WRITE;
/*!40000 ALTER TABLE `imprime_deuda_tributo` DISABLE KEYS */;
/*!40000 ALTER TABLE `imprime_deuda_tributo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `imprime_recibo_pago`
--

DROP TABLE IF EXISTS `imprime_recibo_pago`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `imprime_recibo_pago` (
  `nConId` int(11) NOT NULL AUTO_INCREMENT,
  `Rec_Cod` char(10) NOT NULL,
  `Mes` char(2) NOT NULL,
  `Tributo` char(2) NOT NULL,
  `Tipo` char(1) DEFAULT NULL,
  `Importe` double DEFAULT NULL,
  `Anio` char(4) NOT NULL,
  `Cuota_Cadena` char(65) DEFAULT NULL,
  `Vencimiento` datetime DEFAULT NULL,
  `Corte` datetime DEFAULT NULL,
  `Frac_Nro` char(10) DEFAULT NULL,
  PRIMARY KEY (`Mes`,`Tributo`,`Anio`),
  KEY `fk_imprime_recibo_pago_contribuyente1_idx` (`nConId`),
  KEY `fk_imprime_recibo_pago_recibo_tributo1_idx` (`Rec_Cod`),
  CONSTRAINT `fk_imprime_recibo_pago_contribuyente1` FOREIGN KEY (`nConId`) REFERENCES `contribuyente` (`nConId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_imprime_recibo_pago_recibo_tributo1` FOREIGN KEY (`Rec_Cod`) REFERENCES `recibo_tributo` (`Rec_Cod`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `imprime_recibo_pago`
--

LOCK TABLES `imprime_recibo_pago` WRITE;
/*!40000 ALTER TABLE `imprime_recibo_pago` DISABLE KEYS */;
/*!40000 ALTER TABLE `imprime_recibo_pago` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `imprime_recibo_pago_doble`
--

DROP TABLE IF EXISTS `imprime_recibo_pago_doble`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `imprime_recibo_pago_doble` (
  `Registro` int(11) NOT NULL AUTO_INCREMENT,
  `nConId` int(11) NOT NULL,
  `Rec_Cod` char(10) NOT NULL,
  `Mes` char(2) NOT NULL,
  `Tributo` char(2) NOT NULL,
  `Tipo` char(50) DEFAULT '(1) tributo, (2) Gastos',
  ...
  `Corte` datetime DEFAULT NULL,
  `Frac_Nro` char(10) DEFAULT NULL,
  `Con_Cod_Dos` char(6) DEFAULT NULL,
  `Rec_Cod_Dos` char(10) DEFAULT NULL,
  `Mes_Dos` char(2) DEFAULT NULL,
  `Tributo_Dos` char(2) DEFAULT NULL,
  `Tipo_Dos` char(50) DEFAULT '(1) tributo, (2) Gastos',
  `Importe_Dos` float DEFAULT NULL,
  `Anio_Dos` char(4) DEFAULT NULL,
  `Cuota_Cadena_Dos` char(65) DEFAULT NULL,
  `Vencimiento_Dos` datetime DEFAULT NULL,
  `Corte_Dos` datetime DEFAULT NULL,
  `Frac_Nro_Dos` char(10) DEFAULT NULL,
  PRIMARY KEY (`Registro`),
  KEY `fk_imprime_recibo_pago_doble_recibo_tributo1_idx` (`Rec_Cod`),
  KEY `fk_imprime_recibo_pago_doble_contribuyente1_idx` (`nConId`),
  CONSTRAINT `fk_imprime_recibo_pago_doble_contribuyente1` FOREIGN KEY (`nConId`) REFERENCES `contribuyente` (`nConId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_imprime_recibo_pago_doble_recibo_tributo1` FOREIGN KEY (`Rec_Cod`) REFERENCES `recibo_tributo` (`Rec_Cod`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `imprime_recibo_pago_doble`
--

LOCK TABLES `imprime_recibo_pago_doble` WRITE;
/*!40000 ALTER TABLE `imprime_recibo_pago_doble` DISABLE KEYS */;
/*!40000 ALTER TABLE `imprime_recibo_pago_doble` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `multitabla` VALUES (1,0,'Tipo de Pago','1'),(2,1,'Rentas','1'),(3,1,'Area De Luz','1'),(4,1,'Area De Agua','1'),(5,1,'Desague','1'),(6,1,'Maquinaria','1'),(7,1,'Transportes','1'),(8,1,'Adm Merc. y Camal','1'),(9,1,'Administ. de Piscina','1'),(10,1,'Secretaria General','1'),(11,1,'Asesoria Legal','1'),(12,1,'Tesoreria','1'),(13,1,'Desarrollo Urbano','1'),(14,1,'Registro Civil','1');
...
--
-- Table structure for table `recibo_fraccion_detalle`
--

DROP TABLE IF EXISTS `recibo_fraccion_detalle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recibo_fraccion_detalle` (
  `Rec_Cod` char(10) NOT NULL,
  `nFrtId` int(11) NOT NULL,
  `Cuota_Nro` char(2) NOT NULL,
  `Abono_Tributo` double DEFAULT NULL,
  `Abono_Interes` double DEFAULT NULL,
  KEY `fk_recibo_fraccion_detalle_recibo_tributo1_idx` (`Rec_Cod`),
  KEY `fk_recibo_fraccion_detalle_fraccionamiento_tributo1_idx` (`nFrtId`),
  CONSTRAINT `fk_recibo_fraccion_detalle_fraccionamiento_tributo1` FOREIGN KEY (`nFrtId`) REFERENCES `fraccionamiento_tributo` (`nFrtId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_recibo_fraccion_detalle_recibo_tributo1` FOREIGN KEY (`Rec_Cod`) REFERENCES `recibo_tributo` (`Rec_Cod`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recibo_fraccion_detalle`
--

LOCK TABLES `recibo_fraccion_detalle` WRITE;
/*!40000 ALTER TABLE `recibo_fraccion_detalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `recibo_fraccion_detalle` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recibo_tributo`
--

DROP TABLE IF EXISTS `recibo_tributo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recibo_tributo` (
  `Rec_Cod` char(10) NOT NULL,
  `nConId` int(11) NOT NULL,
  `Rec_Fecha` datetime DEFAULT NULL,
  `Usu_Cod` char(4) DEFAULT NULL,
  `T_Tributo` double DEFAULT NULL,
  `T_Adicional` double DEFAULT NULL,
  `T_Abono` double DEFAULT NULL,
  `Rec_Obs` varchar(100) DEFAULT NULL,
  `Desde` char(2) DEFAULT NULL,
  `Hasta` char(2) DEFAULT NULL,
  `Tipo_Pago` char(1) DEFAULT NULL COMMENT '(N)ormal , (F)raccionado',
  `Tot_Fraccion` double DEFAULT '0',
  PRIMARY KEY (`Rec_Cod`),
  KEY `fk_recibo_tributo_contribuyente1_idx` (`nConId`),
  CONSTRAINT `fk_recibo_tributo_contribuyente1` FOREIGN KEY (`nConId`) REFERENCES `contribuyente` (`nConId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recibo_tributo`
--

LOCK TABLES `recibo_tributo` WRITE;
/*!40000 ALTER TABLE `recibo_tributo` DISABLE KEYS */;
/*!40000 ALTER TABLE `recibo_tributo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `valor_tributo`
--

DROP TABLE IF EXISTS `valor_tributo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `valor_tributo` (
  `Anio` char(4) NOT NULL,
  `T_Agua` double DEFAULT NULL,
  `T_Desague` double DEFAULT NULL,
  `T_Limpieza` double DEFAULT NULL,
  `T_Gastos` double DEFAULT NULL,
  `T_Agua_Esp` double DEFAULT NULL,
  `T_Desague_Esp` double DEFAULT NULL,
  `T_Limpieza_Esp` double DEFAULT NULL,
  `T_Agua_Ind` double DEFAULT NULL,
  `T_Desague_Ind` double DEFAULT NULL,
  `T_Limpieza_Ind` double DEFAULT NULL,
...
--
-- Dumping data for table `valor_tributo`
--

LOCK TABLES `valor_tributo` WRITE;
/*!40000 ALTER TABLE `valor_tributo` DISABLE KEYS */;
/*!40000 ALTER TABLE `valor_tributo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vencimiento_tributo_municipal`
--

DROP TABLE IF EXISTS `vencimiento_tributo_municipal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vencimiento_tributo_municipal` (
  `Anio` char(4) NOT NULL,
  `Cuota` char(2) NOT NULL,
  `Mes_Vence` datetime DEFAULT NULL,
  `Mes_Corte` datetime DEFAULT NULL,
  `Ultima_Act` datetime DEFAULT NULL,
  PRIMARY KEY (`Anio`,`Cuota`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vencimiento_tributo_municipal`
--

LOCK TABLES `vencimiento_tributo_municipal` WRITE;
/*!40000 ALTER TABLE `vencimiento_tributo_municipal` DISABLE KEYS */;
/*!40000 ALTER TABLE `vencimiento_tributo_municipal` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-03-17  3:14:05
