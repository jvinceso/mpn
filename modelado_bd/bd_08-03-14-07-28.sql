...
CREATE TABLE `contribuyente` (
  ...
  `cConDni` char(10) DEFAULT NULL,
  `cConNombre` varchar(50) DEFAULT NULL,
  `cConMzLote` char(50) DEFAULT NULL,
  `cConAgua` char(1) DEFAULT NULL,
  `cConDesague` char(1) DEFAULT NULL,
  `cConLimpieza` char(1) DEFAULT NULL,
  `cConEstado` char(1) DEFAULT NULL,
  `nCalId` int(11) NOT NULL,
  `nSecId` int(11) NOT NULL,
  `dConFecha` datetime DEFAULT NULL,
  ...
  KEY `FK_Contribuyente_Sector` (`nSecId`),
  CONSTRAINT `FK_Contribuyente_Calle` FOREIGN KEY (`nCalId`) REFERENCES `calle` (`nCalId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Contribuyente_Sector` FOREIGN KEY (`nSecId`) REFERENCES `sector` (`nSecId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fraccionamiento_tributo` (
  ...
  `Reg_Estado` char(1) DEFAULT NULL,
  PRIMARY KEY (`nFrtId`),
  KEY `FK_Fraccionamiento_Tributo_Usuario` (`nUsuId`),
  KEY `FK_Fraccionamiento_Tributo_Contribuyente` (`nConId`),
  CONSTRAINT `FK_Fraccionamiento_Tributo_Usuario` FOREIGN KEY (`nUsuId`) REFERENCES `usuario` (`nUsuId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `imprime_recibo_pago` (
  ...
  PRIMARY KEY (`Con_Cod`,`Rec_Cod`,`Mes`,`Tributo`,`Anio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-03-08 19:26:20
