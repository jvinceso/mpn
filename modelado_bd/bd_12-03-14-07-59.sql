...
INSERT INTO `aplicacion` VALUES (1,'Utilitarios','1',' icon-cogs',0,'2014-03-01 18:28:31','1'),(2,'Estadisticas','1','icon-bar-chart ',1,'2014-03-01 21:20:22','1'),(3,'Agua','','icon-cloud',2,'2014-03-06 00:53:09','1'),(4,'Caja','','icon-credit-card',3,'2014-03-06 00:55:30','1');
...
CREATE TABLE `trabajador_municipal` (
  ...
  `nPerId` int(11) NOT NULL,
  `nAreId` int(11) NOT NULL,
  `nTmuCodigoTrabajador` int(11) DEFAULT NULL,
  `nMulCargo` int(11) DEFAULT NULL,
  `fTmuFechaBaja` datetime DEFAULT NULL,
  `cTmuSiglas` varchar(50) DEFAULT NULL,
  `cTmuTratamiento` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2014-03-12 19:58:32
