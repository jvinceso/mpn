...
CREATE TABLE `caja_pagos` (
  ...
  `cCpaPoblador` varchar(50) DEFAULT NULL,
  ...
  `cCpaEstado` varchar(50) NOT NULL DEFAULT '1',
  PRIMARY KEY (`nCpaId`),
...
CREATE TABLE `tributo_municipal` (
  ...
  `Descargado_SN` char(1) DEFAULT 'N',
...
-- Dump completed on 2014-03-10 19:59:19
