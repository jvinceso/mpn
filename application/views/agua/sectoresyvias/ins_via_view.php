...
<form id="frm_ins_via" name = "frm_ins_via" class="form-horizontal" role="form">
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="txt_ins_via_nom" name = "txt_ins_via_nom" placeholder="Ingrese el nombre" class="col-xs-10 col-sm-5" />
		</div>
	</div>	
	<div class="space-4"></div>
	<div class="clearfix form-actions">
		<div class="col-md-offset-3 col-md-9">
			<button id = "btn_ins_via_registrar" class="btn btn-info" data-loading-text="Loading..." type="submit">
