			...
			<ul class="nav nav-tabs" id="TabSectoresyVias">
				<li class="dropdown active">
					...
					<ul class="dropdown-menu dropdown-info">
						<li>
							<a data-toggle="tab" href="#sectoresr">Concepto</a>
						</li>

						<li>
							<a data-toggle="tab" href="#viasr">Tipo de Pago</a>
						</li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-info">
						<li>
							<a id="servicios" data-toggle="tab" href="#serviciosl">Concepto</a>
						</li>
						<li>
							<a data-toggle="tab" href="#viasl">Tipo de Pago</a>
						</li>
					</ul>
				</li>
			</ul>
